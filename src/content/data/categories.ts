...
export const CATEGORIES: Category[] = [
  ...
  k('liquids', 'a liquid', 'liquids', 3, 'science', ['water', 'milk', 'juice', 'oil', 'honey', 'vinegar', 'lava', 'syrup', 'gasoline', 'paint'], { extra: ['mercury', 'soda', 'ink', 'blood'], decoysFrom: ['solids', 'gases'] }),
  ...
  k('plantparts', 'a part of a plant', 'parts of a plant', 3, 'science', ['root', 'stem', 'leaf', 'seed', 'petal', 'bud', 'bark', 'branch', 'blossom', 'pollen'], { extra: ['cell wall', 'membrane', 'cytoplasm', 'chloroplast', 'vacuole', 'nucleus', 'trunk', 'thorn', 'sap', 'stalk', 'fruit', 'flower'] }),
  ...
  k('metals', 'a metal', 'metals', 4, 'science', ['iron', 'gold', 'silver', 'copper', 'aluminum', 'tin', 'lead', 'zinc', 'nickel', 'platinum', 'titanium'], { extra: ['mercury', 'brass', 'bronze', 'steel'], decoysFrom: ['gases', 'rocks', 'minerals'] }),
  ...
  k('carnivores', 'a meat-eater', 'meat-eaters', 4, 'animals', ['lion', 'tiger', 'wolf', 'fox', 'polar bear', 'cheetah', 'leopard', 'hyena', 'lynx', 'jaguar'], { extra: ['shark', 'eagle', 'crocodile', 'hawk', 'owl', 'snake', 'weasel', 'otter'], decoysFrom: ['herbivores'] }),
