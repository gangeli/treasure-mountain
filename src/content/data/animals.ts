...
export const ANIMALS: Animal[] = [
  ...
  A('bear', 'mammal', { baby: 'cub', home: 'den', diet: 'omnivore', hab: 'forest' }),
  A('polar bear', 'mammal', { baby: 'cub', home: 'den', diet: 'carnivore', hab: 'Arctic' }),
  A('panda', 'mammal', { baby: 'cub', diet: 'herbivore', hab: 'forest' }),
  A('wolf', 'mammal', { baby: 'pup', home: 'den', group: 'pack', diet: 'carnivore', hab: 'forest' }),
  ...
  A('eagle', 'bird', { baby: 'eaglet', home: 'nest', diet: 'carnivore', hab: 'mountains' }),
  A('hawk', 'bird', { baby: 'chick', home: 'nest', diet: 'carnivore', hab: 'forest' }),
  ...
  A('elephant', 'mammal', { baby: 'calf', group: 'herd', diet: 'herbivore', hab: 'grassland' }),
  ...
  A('monkey', 'mammal', { baby: 'infant', group: 'troop', diet: 'omnivore', hab: 'rainforest' }),
  ...
  A('platypus', 'mammal', { baby: 'puggle', diet: 'carnivore', hab: 'river' }),
]
