...
export const RIDDLES: RiddleEntry[] = [
  ...
  R(0, 1, ['I have big ears and a trunk.', 'I am very, very big.'], 'an elephant', ['a horse', 'a mouse', 'a dog']),
  ...
  R(0, 2, ['I have a spout and a handle.', 'You water the garden with me.'], 'a watering can', ['a cup', 'a shoe', 'a hat']),
  ...
  R(0, 3, ['I am full of water and glass.', 'Fish swim round and round in me.'], 'a fish tank', ['a cup', 'a box', 'a bed']),
  ...
  R(1, 2, ['I am sweet and cold.', 'You eat me from a cone.'], 'ice cream', ['soup', 'cake', 'toast']),
  ...
  R(3, 1, ['What goes up when the rain comes down?'], 'an umbrella', ['a puddle', 'a boot', 'a cloud']),
  ...
  R(3, 3, ['What can you serve', 'but never eat?'], 'a tennis ball', ['a cake', 'a dinner', 'a pie']),
  // ---- Grade 4 band 1: a single pun, stated plainly.
  R(4, 1, ['What has keys but cannot open', 'a single lock?'], 'a piano', ['a safe', 'a car', 'a drum']),
  R(4, 1, ['What has a bottom at the top?'], 'your legs', ['a hat', 'a hill', 'a boat']),
  ...
  R(4, 2, ['What can you keep', 'after giving it to someone?'], 'your word', ['a gift', 'a coin', 'a book']),
  ...
  R(4, 2, ['What can go up a chimney down', 'but not down a chimney up?'], 'an umbrella', ['smoke', 'a kite', 'a broom']),
  ...
  R(5, 1, ['What has 13 hearts', 'but no other organs?'], 'a deck of cards', ['a hospital', 'an octopus', 'a valentine']),
  R(5, 1, ['What has four wheels and flies?'], 'a garbage truck', ['a plane', 'a helicopter', 'a bus']),
  ...
  R(5, 2, ['What can you hold in your right hand', 'but never in your left hand?'], 'your left hand', ['a pencil', 'a ball', 'a phone']),
  ...
  R(5, 2, ['A boy kicked a ball as hard as he could', 'and it came straight back to him', 'without touching anything. How?'], 'he kicked it straight up', ['it hit a tree', 'a friend threw it', 'it bounced off a wall']),
  ...
  R(5, 3, ['I have keys but open no locks.', 'I have space but no room.', 'You can enter, but not go in.'], 'a keyboard', ['a piano', 'a house', 'a car']),
  ...
  R(5, 3, ['What has a ring but no finger', 'and calls you from far away?'], 'a telephone', ['a mirror', 'a rope', 'a candle']),
  R(5, 3, ['A farmer has 17 sheep.', 'All but nine of them run away.', 'How many sheep are left?'], 'nine', ['eight', 'seventeen', 'zero']),
  R(5, 3, ['A rooster lays an egg on a roof.', 'Which way does the egg roll?'], 'roosters lay no eggs', ['to the left', 'to the right', 'straight down']),
  R(5, 3, ['What is black when it is clean', 'and white when it is dirty?'], 'a chalkboard', ['a shirt', 'a window', 'a plate']),
