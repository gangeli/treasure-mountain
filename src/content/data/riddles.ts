...
export const RIDDLES: RiddleEntry[] = [
  ...
  R(4, 1, ['What has a bottom at the top?'], 'your legs', ['your shoes', 'a steep hill', 'a rowing boat']),
  ...
  R(4, 2, ['What can you keep', 'after giving it to someone?'], 'your word', ['your old coat', 'a gold coin', 'a library book']),
  ...
  R(4, 3, ['What gets sharper', 'the more you use it?'], 'your brain', ['your pencil', 'a knife', 'a spoon']),
  ...
  R(5, 2, ['What can you hold in your right hand', 'but never in your left hand?'], 'your left hand', ['your right hand', 'a tennis ball', 'a sharp pencil']),
  ...
  R(5, 2, ['I am lighter than a feather,', 'yet the strongest person cannot', 'hold me for five minutes.'], 'your breath', ['your shadow', 'a bubble', 'a snowflake']),
