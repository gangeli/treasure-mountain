...
* **Size:** the whole game is one HTML file of a few hundred kilobytes; the signed APK is about 130 KB.
  All art is vector, drawn with Canvas 2D; all sound is synthesised. Nothing leaves the device.
